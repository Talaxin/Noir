...
struct TrackingSettingsView: View {
    ...
    var body: some View {
        ...
        .onChange(of: traktSyncEnabled) { _, value in
            syncManager.setTraktSyncEnabled(value)
        }
        .onChange(of: aniListSyncEnabled) { _, value in
    ...
    private var aniListSection: some View {
        Section {
            providerCard(
                logoURL: URL(string: "https://raw.githubusercontent.com/maxtori1/Ryu/2f10226aa087154974a70c1ec78aa83a47daced9/Ryu/Assets.xcassets/Listing/Anilist.imageset/anilist.png"),
    ...
    private var infoSection: some View {
        Section {
            Text("Trakt receives watch progress updates. AniList updates when an episode/movie reaches completion.\n\nmaxtori1 and Noir are not affiliated with AniList nor Trakt, push updates may be incorrect sometimes.")
                .font(.footnote)
        } header: {
            Text("How It Works")
        }
