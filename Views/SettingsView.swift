...
struct SettingsView: View {
        ...
        HStack(spacing: 0) {
            VStack(spacing: 30) {
                ...
                VStack(spacing: 15) {
                    ...
                    Text("Copyright © \(String(Calendar.current.component(.year, from: Date()))) Noir by maxtori")
                        .font(.footnote)
                        .fontWeight(.semibold)
    ...
    private var settingsContent: some View {
        List {
            ...
            Section(footer: Text("Version \(Bundle.main.appVersion) (\(Bundle.main.buildNumber)) - maxtori1")) {}
        }
#if !os(tvOS)
