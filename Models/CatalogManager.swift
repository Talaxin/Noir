...
class CatalogManager: ObservableObject {
    ...
    private func loadCatalogs() {
        // Default catalogs (Continue Watching first)
        let defaultCatalogs: [Catalog] = [
            Catalog(id: "continueWatching", name: "Continue Watching", source: .local, isEnabled: true, order: 0),
            Catalog(id: "forYou", name: "Just For You", source: .local, isEnabled: true, order: 1),
