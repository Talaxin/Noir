...
struct TMDBSearchResult: Codable, Identifiable {
    ...
    var fullPosterURL: String? {
        ...
        return "\(TMDBConstants.tmdbImageBaseURL)\(posterPath)"
    }
    
    var fullBackdropURL: String? {
        guard let backdropPath = backdropPath else { return nil }
        return "\(TMDBConstants.tmdbImageBaseURL)\(backdropPath)"
    }
}
...
struct TMDBEpisode: Codable, Identifiable {
    ...
    var fullStillURL: String? {
        ...
        return "\(TMDBConstants.tmdbImageBaseURL)\(stillPath)"
    }
...
struct TMDBImage: Codable {
    ...
    var fullURL: String {
        return "\(TMDBConstants.tmdbImageBaseURL)\(filePath)"
    }
}
